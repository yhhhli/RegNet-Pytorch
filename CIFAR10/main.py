...
parser.add_argument('-a', '--arch', metavar='ARCH', default='regnet_200m')
...
def main():
    ...
    if use_gpu:
        assert args.arch in model_names, 'Network Architecture Not Supported'
    ...
    fdir = 'checkpoints/'+str(args.arch)+'_'
    ...
    if args.evaluate:
        ckpt = torch.load(fdir+'/model_best.pth.tar')
